...
#' @keywords excd, phylo.d, Fritz & Purvis
#' @param data a data.frame object
#' @param tree An object of class 'phylo'
#' @param names.col A *string* specifying the column in 'data' that matches rows to tips in 'phy'
#' @return See \link[caper]{phylo.d}
#' @export
